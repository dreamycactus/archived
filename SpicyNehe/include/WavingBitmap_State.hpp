#ifndef WAVINGBITMAP_STATE_H
#define WAVINGBITMAP_STATE_H
...
class WavingBitmap_State : public STATE::iGameState
{
    public:
        WavingBitmap_State();
        virtual ~WavingBitmap_State();
